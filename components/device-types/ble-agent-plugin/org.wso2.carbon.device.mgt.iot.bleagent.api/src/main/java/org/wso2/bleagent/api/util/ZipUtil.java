...
public class ZipUtil {
    ...
    public ZipArchive createZipFile(String owner, String tenantDomain, String deviceType,
                                    ...
                                    String refreshToken, int profileId) throws DeviceManagementException {
        ...
        try {
            ...
            contextParams.put("PROFILE_ID", Integer.toString(profileId));

...
public class Constants {
    ...
    public static final String DEFAULT_PERMISSION_RESOURCE = "/permission/admin/device-mgt/bleagent/user";
    public static final String DEFAULT_ROLE_NAME = "bleagent_user";

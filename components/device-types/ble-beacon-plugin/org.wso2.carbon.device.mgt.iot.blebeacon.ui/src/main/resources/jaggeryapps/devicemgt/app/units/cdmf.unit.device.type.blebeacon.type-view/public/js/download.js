...
function addiBeacon() {
    ...
    var payload = {};
    payload.beaconName = $inputs[0].value;
    payload.uuid = $inputs[1].value;
    payload.major = $inputs[2].value;
...
function addEddystone(){
    console.log("1");
    var $inputs = $('#eddystoneForm :input');
    ...
    var payload = {};
    payload.beaconName = $inputs[0].value;
    payload.namespace = $inputs[1].value;

...
public class Constants {
    ...
    public static final String DEFAULT_PERMISSION_RESOURCE = "/permission/admin/device-mgt/blebeacon/user";
    public static final String DEFAULT_ROLE_NAME = "blebeacon_user";

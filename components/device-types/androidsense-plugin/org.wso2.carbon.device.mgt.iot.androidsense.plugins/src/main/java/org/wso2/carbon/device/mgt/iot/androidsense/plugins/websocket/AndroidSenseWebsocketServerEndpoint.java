...
package org.wso2.carbon.device.mgt.iot.androidsense.plugins.websocket;
...
@Singleton
public class AndroidSenseWebsocketServerEndpoint {

    private static Log log = LogFactory.getLog(AndroidSenseWebsocketServerEndpoint.class);

package org.wso2.carbon.device.mgt.iot.digitaldisplay.plugin.config;
...
import org.wso2.carbon.device.mgt.iot.digitaldisplay.plugin.config.exception.DigitalDisplayConfigurationException;
...
public class DigitalDisplayConfig {
    ...
    private static Document convertToDocument(File file) throws DigitalDisplayConfigurationException {

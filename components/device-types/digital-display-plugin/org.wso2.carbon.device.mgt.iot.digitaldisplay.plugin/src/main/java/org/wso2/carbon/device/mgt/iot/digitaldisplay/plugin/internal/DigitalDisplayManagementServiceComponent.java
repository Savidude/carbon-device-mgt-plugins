...
import org.wso2.carbon.device.mgt.iot.digitaldisplay.plugin.impl.DigitalDisplayStartupListener;
...
//    private ServiceRegistration firealarmServiceRegRef;
    ...
    protected void setCertificateManagementService(CertificateManagementService certificateManagementService) {
        DigitalDisplayManagementDataholder.getInstance().setCertificateManagementService(certificateManagementService);
    }

    protected void unsetCertificateManagementService(CertificateManagementService certificateManagementService) {
        DigitalDisplayManagementDataholder.getInstance().setCertificateManagementService(null);
    }
}

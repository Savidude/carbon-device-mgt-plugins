...
import org.wso2.carbon.device.mgt.iot.digitaldisplay.plugin.internal.DigitalDisplayManagementDataholder;
import org.wso2.carbon.device.mgt.iot.digitaldisplay.plugin.mqtt.MqttConfig;
...
public class DigitalDisplayUtil {
    private static Log log = LogFactory.getLog(DigitalDisplayUtil.class);
    ...
    public static void setupMqttInputAdapter() throws IOException {
        ...
        try {
            ...
            DigitalDisplayManagementDataholder.getInstance().getInputEventAdapterService()
                    .create(inputEventAdapterConfiguration, new DigitalDisplayEventAdapterSubsciption());

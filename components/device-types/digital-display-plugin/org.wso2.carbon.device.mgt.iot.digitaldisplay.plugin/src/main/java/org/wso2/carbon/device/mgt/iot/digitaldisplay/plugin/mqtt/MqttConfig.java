package org.wso2.carbon.device.mgt.iot.digitaldisplay.plugin.mqtt;
...
import org.wso2.carbon.device.mgt.iot.digitaldisplay.plugin.config.DeviceManagementConfiguration;
import org.wso2.carbon.device.mgt.iot.digitaldisplay.plugin.config.DigitalDisplayConfig;
import org.wso2.carbon.device.mgt.iot.digitaldisplay.plugin.config.EventListenerConfiguration;
...
public class MqttConfig {
    ...
    private MqttConfig(){
        DeviceManagementConfiguration deviceManagementConfiguration = DigitalDisplayConfig.getInstance().getDeviceTypeConfiguration();

...
public class AuthorizationConfigurationManager {
    ...
    public synchronized void initConfig() {
        List<String> mqttTransportAuthorizationProperties = AuthorizationConfiguration.readValueList(AMQPConfiguration
                .LIST_TRANSPORT_AMQP_AUTHORIZATION_PROPERTIES);
        for (String property : mqttTransportAuthorizationProperties) {
            String propertyValue = AuthorizationConfiguration.readValueOfChildByKey(
                    AMQPConfiguration.TRANSPORT_AMQP_AUTHORIZATION_PROPERTIES, property);
            switch (property) {

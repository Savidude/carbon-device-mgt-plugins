...
import org.wso2.carbon.andes.extensions.device.mgt.amqp.authorization.exception.AuthorizationException;
...
public class AuthorizationConfiguration {
     ...
     */
    static <T> T readValueOfChildByKey(AMQPConfiguration configurationProperty, String key) {
     ...
     */
    static List<String> readValueList(AMQPConfiguration configurationProperty) {
